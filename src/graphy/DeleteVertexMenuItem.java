    ...
    public DeleteVertexMenuItem() {
        ...
        this.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if (MyVertexFactory.sourceVertex.equals(vertex))
                            MyVertexFactory.sourceVertex = null;
                    if (MyVertexFactory.sinkVertex.equals(vertex))
                            MyVertexFactory.sinkVertex = null;
