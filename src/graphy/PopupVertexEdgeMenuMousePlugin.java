...
public class PopupVertexEdgeMenuMousePlugin<V, E> extends AbstractPopupGraphMousePlugin {
    ...
    public PopupVertexEdgeMenuMousePlugin() {
        this(MouseEvent.BUTTON3_MASK);  // Right mouse button mask
    }
    ...
    protected void handlePopup(MouseEvent e) {
        ...
        // getPickSupport returns the GraphElementAcessor
        GraphElementAccessor<V,E> pickSupport = vv.getPickSupport();
        
        if(pickSupport != null) {
            // Get the vertex that was right-clicked
            final V v = pickSupport.getVertex(vv.getGraphLayout(), p.getX(), p.getY());
            
            // If a vertex was actually right-clicked
            if(v != null) {
